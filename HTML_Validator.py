...
def _extract_tags(html):
    '''
    This is a helper function for `validate_html`. By convention in Python, helper functions 
    that are not meant to be used directly by the user are preixed with an underscore.
    ...
    ['<strong>', '</strong>']
    '''
    extracted_tags= re.findall('<[\/a-z0-9]+>', html)
